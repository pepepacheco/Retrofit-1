    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        enviar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                alumno = new Alumno(null, dni.getText().toString(), nombre.getText().toString(), apellidos.getText().toString(), eMail.getText().toString());
                AlumnoRest.postAlumno(view, alumno);
